...
3. Program melakukan hal-hal dibawah ini:<br>
    ...
    3.3. Memasukkan data yang telah diproses ke algoritma Linear Regression yang sudah kalian buat<br>
    3.4. Menunjukkan akurasi dari algoritma yang telah dibuat terhadap dataset yang diberikan.<br>
    3.5. Memvisualisasikan hasil prediksi dengan scatter plot (untuk datanya) + line plot (untuk modelnya)<br>
